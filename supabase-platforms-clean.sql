-- ============================================
-- Next Read: Fixed Platform Schema
-- Run this in Supabase SQL Editor AFTER dropping the foreign key
-- ============================================

-- First, if you're still seeing the foreign key error, run this:
-- ALTER TABLE articles DROP CONSTRAINT IF EXISTS articles_platform_id_fkey;
...
-- 2. Add platform_id to articles (skip if already exists)
DO $$
BEGIN
  IF NOT EXISTS (
